...
- final HEAD incl. report: `90232d5` → run `35086483790` — **success** (all 5
  jobs, R87 step green on both platforms)
...
- run `35085855956` (HEAD `e701432`, report + CI record): **success** — all 5
  jobs green, R87 Phase A step green on both platforms.
- run `35086483790` (final HEAD `90232d5`, this report): **success** — all 5
  jobs green (verify ubuntu + verify windows, coverage gate, cold-start ubuntu,
  release attestation), R87 Phase A step green on both platforms.
- URL: https://github.com/ki11a-Conton/harness-agent/actions/runs/35086483790