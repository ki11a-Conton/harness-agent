...
import { auditSummary, buildCapabilityMatrix, capabilityStatusOf, } from "./audit.js";
/**
 ...
 */
const PERSISTENT_INTROSPECTION = {
    profile: "interactive",
    registeredTools: [
        "read_file",
        "write_file",
...
function persistentInput(overrides = {}) {
    return {
...
//# sourceMappingURL=audit.persistent-profile.test.js.map