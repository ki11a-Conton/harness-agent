...
import { auditCmd, buildCapabilityMatrix, capabilityStatusOf, probeWorkspace } from "./audit.js";
...
describe("audit benchmark profile — real workspace probes (P0-1)", () => {
    ...
    it("`agent audit --out` writes CAPABILITY_MATRIX.json + .md and exits 0 on truthful docs (P4-1)", async () => {
        ...
        const json = JSON.parse(await readFile(join(out, "CAPABILITY_MATRIX.json"), "utf8"));
...
//# sourceMappingURL=audit.benchmark-profile.test.js.map