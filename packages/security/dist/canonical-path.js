 ...
 */
export function canonicalizePath(target, opts) {
...
function canonicalAncestorAndTail(p) {
 ...
 */
export function isPathCanonicallyWithin(target, root, cwd, caseInsensitive) {
