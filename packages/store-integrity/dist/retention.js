 ...
 *  aborts the sweep. */
export async function enforceArtifactRetention(dir, options) {
    let entries;
    try {
 ...
 */
export async function archiveFile(activeDir, fileName, archiveDir) {
