...
import { newSessionId, newToolCallId, newTurnId, } from "@ar/contracts";
...
function scriptedProvider(script) {
        ...
        createClient(_m, _c) {
            return {
                async *generate(request) {
                    ...
                    index += 1;
                    const entryEvents = typeof entry === "function" ? entry(request.system ?? "") : (entry ?? []);
    ...
    const model = { providerId: "scripted-worker", modelId: "w" };
...
//# sourceMappingURL=delegation-worker.integration.test.js.map