...
const MEMORY_CONTENT = "when a tool fails with ENOENT for a guessed path, search the repository tree before retrying the same path";
describe("P2-10: memory pre-turn retrieval through the real harness", () => {
    it("injects the retrieved memory into the model context and updates the funnel", async () => {
        ...
        try {
            ...
            expect(retrieved[0].payload.memoryIds.length).toBe(1);
...
//# sourceMappingURL=memory.integration.test.js.map