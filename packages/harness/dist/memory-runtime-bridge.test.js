...
import { MemoryRuntimeBridge, memoryIdsOfBlocks, renderMemoryForModel, } from "./memory-runtime-bridge.js";
let tempDirs = [];
...
describe("P2-1/P2-2: retrieval → context blocks", () => {
    it("renders a structured lesson as an advisory When/Do/Avoid block", async () => {
        ...
        const store = new JsonlMemoryStore({ dataDir });
        const lesson = {
...
describe("P2-4: usefulness feedback funnel", () => {
    ...
    it("feedback on a missing/deleted entry is a silent no-op", async () => {
        ...
        await expect(bridge.recordOutcome([newMemoryId()], { sessionId: newSessionId(), succeeded: true })).resolves.toBeUndefined();
    });
});
...
//# sourceMappingURL=memory-runtime-bridge.test.js.map