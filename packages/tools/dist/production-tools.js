...
let sharedRepoMapResolver;
export function getSharedRepoMapResolver() {
 ...
 */
export function createProductionTools(deps) {
    const repoMap = createRepoMapTool(deps.repoMapResolver ?? getSharedRepoMapResolver());
    const networkPolicy = deps.networkMode;
    const networkMode = typeof networkPolicy === "function" ? networkPolicy : () => networkPolicy;
...
//# sourceMappingURL=production-tools.js.map