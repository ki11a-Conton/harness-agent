...
const ref = (modelId) => ({ providerId: "openai", modelId });
describe("capability resolver (P1-19)", () => {
    ...
    it("host overrides win over everything", () => {
        const info = { id: "gpt-4o", capabilities: { contextWindowTokens: 64_000 } };
...
//# sourceMappingURL=capability-resolver.test.js.map