...
export declare const GRANT_BOUNDS: readonly ["one_call", "one_tool", "session"];
...
export declare function isGrantExpired(grant: SessionPermissionGrant, now: number): boolean;
/** Milliseconds until the hard expiry; 0 once expired. */
export declare function grantRemainingMs(grant: SessionPermissionGrant, now: number): number;
/**
 ...
 */
export declare function consumePermissionGrantUsage(grant: SessionPermissionGrant, now: number): SessionPermissionGrant | undefined;
/**
...
//# sourceMappingURL=permission-expiry.d.ts.map