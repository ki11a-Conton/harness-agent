 ...
 */
export type TerminationReason = "verified_complete" | "model_stopped" | "verification_failed" | "model_error" | "provider_error" | "tool_error" | "sandbox_denied" | "permission_denied" | "security_denied" | "context_limit" | "tool_limit" | "time_limit" | "agent_limit" | "cancelled" | "resume_ambiguous";
...
export declare const TERMINATION_REASONS: readonly ["verified_complete", "model_stopped", "verification_failed", "model_error", "provider_error", "tool_error", "sandbox_denied", "permission_denied", "security_denied", "context_limit", "tool_limit", "time_limit", "agent_limit", "cancelled", "resume_ambiguous"];
export declare function isTerminationReason(value: unknown): value is TerminationReason;
/**
 ...
 */
export declare const LIMIT_TERMINATION_REASON: Readonly<Record<string, TerminationReason>>;
/**
 ...
 */
export type FalseCompleteGrade = "unverified_complete" | "verification_failed" | "verified_partial" | "verified_complete";
...
export declare function gradeCompletion(reason: TerminationReason, evidence?: CompletionEvidence): FalseCompleteGrade;
