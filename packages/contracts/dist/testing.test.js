...
import { fixtureAgentId, makeEvent, makeEventId, makeSeed, makeSession, makeSessionId, makeTurn, makeTurnId, } from "./testing.js";
describe("Q-9 test fixture builders — determinism", () => {
    ...
    it("makeEvent produces a deterministic event snapshot", () => {
        const e = makeEvent({ n: 2, seed: makeSeed() });
