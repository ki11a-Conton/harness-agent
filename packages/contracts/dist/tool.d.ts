...
export declare const DEFAULT_TOOL_CAPABILITY: ToolCapability;
/**
 ...
 */
export declare const DEFAULT_TOOL_SEMANTICS: ToolSemantics;
...
export declare function mayHaveSideEffect(semantics: ToolSemantics): boolean;
 ...
 *  name matching). */
export declare function toToolSemantics(metadata: ToolMetadata, risk?: ToolRisk): ToolSemantics;
...
export declare const TOOL_ERROR_CODES: readonly ["TOOL_SCHEMA_ERROR", "PERMISSION_DENIED", "APPROVAL_DENIED", "SANDBOX_DENIED", "PROCESS_ERROR", "PROCESS_TIMEOUT", "NETWORK_ERROR", "RESOURCE_LIMIT", "USER_CANCELLED", "INTERNAL_ERROR"];
...
export interface ToolOrchestrator {
    execute(request: ToolCallRequest, context: ToolExecutionContext): Promise<ToolResult<unknown>>;
}
