...
export declare const ASK_REASONS: readonly ["missing_critical_input", "ambiguous_goal", "unresolvable_context", "choice_required"];
export declare function isAskReason(value: unknown): value is AskReason;
...
export interface AskUserLifecycle<T extends AskUserRequest = AskUserRequest> {
     ...
     */
    resumePrompt(reply: AskUserReply): {
        content: string;
        askId: AskId;
    };
...
export declare const defaultAskUserLifecycle: AskUserLifecycle;
