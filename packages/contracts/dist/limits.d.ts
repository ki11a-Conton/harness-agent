...
export declare const DEFAULT_DELEGATION_LIMITS: DelegationLimits;
 ...
 */
export declare function resolveChildLimits(limits: Pick<DelegationLimits, "maxChildren" | "maxChildrenTotal" | "maxActiveChildren">): {
    total: number;
    active?: number;
};
...
export declare const TREE_BUDGET_HEADROOM_RATIO = 0.2;
...
export declare const DEFAULT_SCHEDULER_LIMITS: SchedulerLimits;
