...
function serialize(value, opts, seen, path) {
    if (value === undefined)
        return opts.undefined === "undefined" ? "undefined" : "null";
    ...
    if (Array.isArray(value)) {
        if (seen.has(value))
            throw new StableSerializationError(`cyclic reference at ${path}`);
        seen.add(value);
        try {
...
export function computeStableSha256(value, options) {
