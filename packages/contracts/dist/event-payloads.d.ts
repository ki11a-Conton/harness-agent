...
export type EventPayloadOf<T extends EventType> = T extends keyof EventPayloadMap ? EventPayloadMap[T] : Record<string, unknown>;
/**
 ...
 */
export declare function toolNameOf(payload: object): string | undefined;
/**
 ...
 */
export declare const EVENT_PAYLOAD_TYPES: {
    readonly "tool.requested": true;
    readonly "tool.permission_requested": true;
    readonly "tool.permission_resolved": true;
    readonly "tool.started": true;
    readonly "tool.output": true;
    readonly "tool.completed": true;
    readonly "tool.failed": true;
    readonly "model.completed": true;
    readonly "model.retry": true;
    readonly "verification.completed": true;
    readonly "verification.failed": true;
    readonly "context.compacted": true;
    readonly "run.limit_reached": true;
    readonly "turn.completed": true;
    readonly "approval.resolved": true;
    readonly "security.network_denied": true;
    readonly "security.injection_denied": true;
    readonly "security.permission_denied": true;
    readonly "security.filesystem_denied": true;
    readonly "security.process_denied": true;
    readonly "security.secret_redacted": true;
    readonly "security.memory_denied": true;
    readonly "security.skill_denied": true;
    readonly "security.mcp_denied": true;
    readonly "security.approval_denied": true;
};
