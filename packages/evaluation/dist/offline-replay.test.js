...
import { replayAttribution, replayEvaluator, replayMemoryRanker, rankerHitRate, testNewJudge, } from "./offline-replay.js";
function run(caseId, passed, tokens = 1000) {
    return {
        caseId,
        outcome: {
            caseId,
...
const currentJudge = (o) => o.status === "passed";
const strictLeftGuard = (items, k) => [...items].sort((a, b) => b.score - a.score).slice(0, k).map((x) => x.id);
...
describe("P3-15 offline trace replay — new judge", () => {
    it("detects which cases flip under a new judge and new failures", () => {
        ...
        const stricter = (o) => o.status === "passed" && o.metrics.tokens_input <= 900;
...
//# sourceMappingURL=offline-replay.test.js.map