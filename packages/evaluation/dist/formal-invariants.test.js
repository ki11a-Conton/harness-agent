...
import { allPass, checkInvariants, invChildCapabilityIsConferredBound, invChildContextIsolation, invDelegationBounded, invHoldoutJudgeSecrecy, invMemoryUnsafeContentCannotPersist, invNetworkDeniedCannotExecute, invReplayNoDuplicateUnsafeSideEffect, invTerminalStateCannotTransition, invUnsafeToolNeverAutoRetried, invVerificationCannotBeFabricated, violated, } from "./formal-invariants.js";
...
describe("P3-17 INV-010 replay cannot duplicate known completed unsafe side effect", () => {
    ...
    it("fails when replay re-executes a known completed unsafe side effect", () => {
        const r = invReplayNoDuplicateUnsafeSideEffect([{ effectId: "e1", unsafe: true, completed: true }], [{ effectId: "e1", executed: true }]);
        expect(r.ok).toBe(false);
...
//# sourceMappingURL=formal-invariants.test.js.map