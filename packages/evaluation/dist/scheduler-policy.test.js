...
describe("P3-12 scheduler policy — stress-suite promotion", () => {
    ...
    it("stressStable fails on raised false-complete / latency / token overruns", () => {
        ...
        expect(stressStable({ ...CHAMP, p95LatencyMs: 99_999 }, { p95LatencyMsBudget: 50_000 }).stable).toBe(false);
        expect(stressStable({ ...CHAMP, totalTokens: 99_999 }, { tokenBudget: 50_000 }).stable).toBe(false);
...
//# sourceMappingURL=scheduler-policy.test.js.map