...
import { BENCHMARK_SUITE_VERSION, buildRunManifest, computeRuntimeConfigHash, stableStringify, } from "./manifest.js";
...
describe("stableStringify (Q-5)", () => {
    it("handles nested objects, arrays, and primitives deterministically", () => {
        ...
        expect(stableStringify(value)).toBe('{"a":"x","b":[1,{"c":true}],"n":null,"u":undefined}');
    });
