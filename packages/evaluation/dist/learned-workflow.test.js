...
import { learnWorkflow, promoteWorkflow, rollbackWorkflow, shouldApplyWorkflow, workflowMatches, assertNoGateBypass, simulateWorkflowRun, runWorkflowExperiment, } from "./learned-workflow.js";
const CASE = {
    id: "wf-case",
    task: "do the thing",
...
describe("P3-6 learned workflow — end-to-end", () => {
    it("learn → promote → apply lifts matching-type cases", async () => {
        const training = Array.from({ length: 5 }, (_, i) => makeRun(`tr${i}`, "passed", ["read_file", "edit_file", "exec", "verify_step"]));
        const result = await runWorkflowExperiment(training, {
...
//# sourceMappingURL=learned-workflow.test.js.map