...
function makeTask(verification = []) {
...
async function run(fake, opts = makeOpts(), verification = []) {
...
//# sourceMappingURL=runtime-verifier.test.js.map